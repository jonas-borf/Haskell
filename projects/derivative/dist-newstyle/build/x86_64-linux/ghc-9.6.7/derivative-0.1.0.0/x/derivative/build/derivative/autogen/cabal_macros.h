...
/* package derivative-0.1.0.0 */
#ifndef VERSION_derivative
#define VERSION_derivative "0.1.0.0"
#endif /* VERSION_derivative */
#ifndef MIN_VERSION_derivative
#define MIN_VERSION_derivative(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_derivative */
...
#define CURRENT_COMPONENT_ID "derivative-0.1.0.0-inplace-derivative"
